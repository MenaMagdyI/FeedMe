...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction materialFavoriteButton = onView(
                withId(R.id.favorite_nice));
        materialFavoriteButton.perform(scrollTo(), click());
